import exercise.exercise4.MyComparator;
import exercise.exercise4.MyImplementedList;
import exercise.exercise4.MyIterator;
...
public class Exercise4Test {
    ...
    public void testIsEmptyMethodOverIntegerList() {
        //TODO use Iterator
//        MyIterator<Integer> it = testingIntegerValues.iterator;
//       while(it.hasNext()) {
//            testingIntegerValues.remove(it.next());
//        }
//
...
//        }
    ...
    public void testSortMethodOverStringList() {
        testingStringValues.sort(new MyComparator<String>());
    }
}
