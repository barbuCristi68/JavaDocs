...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        //  Exercise 2 c2) Check if Object o is null
            ...
            if(!this.getId().equals(newStudent.getId())) return false;
            if(!this.getAverageGrade().equals(newStudent.getAverageGrade())) return false;
    ...
    public int hashCode() {
        ...
        result = 31*result + this.getAverageGrade().hashCode();
